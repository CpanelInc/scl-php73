...
ln -sf /opt/cpanel/ea-php73/root/usr/bin/php-cgi $DEB_INSTALL_ROOT/usr/bin/ea-php73
...
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php73$_sysconfdir/php.d
...
do
    ...
    if [ -f "$buildroot/$ini" ]; then
      cp -p $buildroot/$ini ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php73$_sysconfdir/php.d/$ini
    else
      cat > ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php73$_sysconfdir/php.d/$ini <<EOF
...
install -m 644 $SOURCE51 $DEB_INSTALL_ROOT/opt/cpanel/ea-php73$_sysconfdir/php.d/opcache-default.blacklist
# Install the macros file:
install -d $DEB_INSTALL_ROOT/opt/cpanel/ea-php73$_root_sysconfdir/rpm
install -m 644 -c macros.php \
           $DEB_INSTALL_ROOT/opt/cpanel/ea-php73$_root_sysconfdir/rpm/macros.$name
...
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/phar.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/phar.phar.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/php-cgi.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/php.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/phpize.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/phpdbg.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/phpconfig.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man1/php-config.1
gzip debian/tmp/opt/cpanel/ea-php73/root/usr/share/man/man8/php-fpm.8
...
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php73/root/var/run/php-fpm
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php73/root/var/log/php-fpm
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php73/root/etc/sysconfig/php-fpm
